...
<div class="flex flex-col md:flex-row md:items-start space-y-4 md:space-y-0 md:space-x-6">
 ...
 <div class="w-1/2">
  {{< image src="/images/eau_introduction.jpg" caption="" alt="Mare" height="" width="" position="center" command="fill" option="q100" style="height: 400px; width: auto; object-fit: cover; border-radius: 8px;" class="img-fluid" title="Mare" webp="true" >}}
 </div>
</div>
...
Idéalement, l'eau va compléter différents cycles, je vous recommande à ce sujet la [vidéo d'Hervé Covès : Les 7 cycles de l'eau.](https://www.youtube.com/watch?v=ZhtQ89NzOjs&t=1637s "Les 7 cycles de l'eau") 
Du coup, même si l'on peut envisager différentes formes de captage et de stockage pour prévenir le manque d'eau, cela ne vaudra jamais la présence de forêts qui jouent un rôle essentiel dans le captage et la redistribution de la ressource.
{.text-lg .mb-4}
