...
Dans l’optique de la mise en place d’une lettre d’information par messages électroniques et alphanumériques portant sur notre communication associative à laquelle vous pourrez, le cas échéant, souscrire. Nous utiliserions alors les données à caractère personnel que vous nous avez fournies lors de votre inscription. Vous pourrez vous désabonner, le cas échéant, de ces envois à tout moment. 
...
### Adhésion à notre futur Newsletter

Vous pourez consentir directement à la réception de nos lettres d’information en renseignant votre adresse email aux endroits prévus à cet effet sur le Site.
...
Afin de donner suite aux demandes que vous pourriez effectuer auprès de notre association et de confirmer les informations vous concernant, nous pourrons utiliser vos nom(s), prénom(s), adresse(s) de courrier électronique et numéro(s) de téléphone.
...
Les données à caractère personnel sont susceptibles d’être transférées vers des pays situés hors de l’Union Européenne (tels que les États-Unis via des services de traitement tiers comme Google notamment dans un objectif d’indexation du site internet.

D’autres transferts de données à caractère personnel vers les Etats-Unis sont régis par le E.U. – U.S. PRIVACY SHIELD (Bouclier de protection des Données Union Européenne-Etats-Unis) : [**cliquez ici pour plus d’informations**](https://www.cnil.fr/fr/le-privacy-shield). 
...
Nous ne conserverons vos données à caractère personnel que si vous souhaitez devenir membre de l’association et uniquement dans un but de communication en lié avec l’activité de l’association.

Ainsi, toutes les données à caractère personnel obtenues via l’analyse statistiques anonymes réalisés à l’aide du logiciel open source Matomo seront automatiquement effacées. elles seront traitées conformément aux utilisations exposées dans la présente Charte et dans le respect des lois et règlements.
...
- de mémoriser des informations relatives à un formulaire que vous avez rempli sur notre Site .
...
Conformément à la réglementation applicable, vous pouvez refuser l’utilisation des cookies qui ne sont pas strictement nécessaires.
...
Vous pouvez nous contacter afin d’exercer vos droits via [**notre formulaire de contact**](https://lafermetteverdoyante.com/fr/contact).

Par ailleurs, vous pourrez à tout moment vous désabonner de notre newsletter en cliquant sur le lien qui permet le désabonnement en bas de chaque email. Vous pouvez également vous désabonner en envoyant un message via [**notre formulaire de contact**](https://lafermetteverdoyante.com/fr/contact). 
