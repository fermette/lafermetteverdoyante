...
<div class="flex flex-col md:flex-row md:items-center gap-4 md:gap-0">
  ...
  <div class="prose max-w-none mt-4 md:mt-0 md:ml-6 text-lg text-text dark:text-darkmode-text-dark">
    ...
    <p></p>  
    L'incroyable diversité de variétés proposées aujourd'hui peuvent permettre une évolution vers <b>un mode de consommation en adéquation avec l'environnement</b>, encore plus si celui-ci intégre les plantes endémiques, dites <b>sauvages</b> ou <b>evahissantes</b> qui sont de véritable cadeau d'un point de vu nutritonel pour notre organisme !
    <p></p> 
    Varier les <b>formes</b>, les <b>couleurs</b> et les <b>goûts</b> sont les bases de nombreuses cuisine du monde, et l'essence de la cuisine française.
    <p></p>
    Recettes et techniques de préparation sont aussi un excellent sujet de conversation qui régale tous les gastronomes en herbe
  </div>
</div>
<br>
...
Avant d'aborder les questions de transformation à proprement parler, il est essentiel de prévoir des espaces de stockages adéquates.
{.text-lg .mb-4}
Que ce soit pour les produits frais dans une cave ou pour les conserves et les produits séchés dans un cellier, il y a des considérations souvent ignorées dont il faut tenir compte :
{.text-lg .mb-4}
<ul class="text-lg mb-4 pl-6">
<li>Le volume de stockage de ces emplacements qui doit correspondre logiquement au volume des récoltes</li>
<li>L'organistion pratique à l'aide d'étagères et meubles de rangements </li>
<li>Le taux d'humidité et la température du local, différents selon les produits qui y seront stockés </li>
...
<li>Le tout à l'abris des rongeurs et insectes</li>
</ul> 
...
<div class="flex flex-col md:flex-row md:items-start space-y-4 md:space-y-0 md:space-x-6">
 <div class="md:w-1/2">
    <p class="text-lg mb-4">Élément 1 : texte explicatif.</p>
    <p class="text-lg mb-4">Élément 2 : autre information.</p>
