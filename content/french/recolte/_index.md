...
<div class="flex flex-col md:flex-row md:items-center gap-4 md:gap-0">
  ...
  <div class="prose max-w-none mt-4 md:mt-0 md:ml-6 text-lg text-text dark:text-darkmode-text-dark">
    <p class="mb-4 text-lg">La clé d'une alimentation saine :</p>
    <p class="mb-4 text-lg">L'incroyable diversité de variétés proposées aujourd'hui peuvent permettre une évolution vers <b>un mode de consommation en adéquation avec l'environnement</b>, encore plus si celui-ci intégre les plantes endémiques, dites <b>sauvages</b> ou <b>evahissantes</b> qui sont de véritable cadeau d'un point de vu nutritonel pour notre organisme !</p>
  </div>
</div>
