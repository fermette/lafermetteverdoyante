...
Our Farm is a place for acclimatization and experimentation.
{.text-lg .mb-4}
...
{{< image src="/images/culture_poire&riz.jpg" caption="Rice crop in the foreground, and yacon (Peruvian ground apple) in the background" alt="Experimental crops" height="" width="" position="center" command="fill" option="q100" style="height: 300px; width: auto; object-fit: cover; border-radius: 8px;" class="img-fluid" title="Experimental crops" webp="true" >}}
...
{{< image src="/images/culture_structure2.jpg" caption="Crops on netting with wooden frame" alt="Culture on structure" height="" width="" position="center" command="fill" option="q100" style="height: 300px; width: auto; object-fit: cover; border-radius: 8px;" class="img-fluid" title="Culture on structure" webp="true" >}}
...
{{< image src="/images/culture_structure1.jpg" caption="Layered crops on a removable reinforcing steel structure" alt="Cultivation on a structure"  alt="Culture sur structure" height="" width="" position="center" command="fill" option="q100" style="height: 300px; width: auto; object-fit: cover; border-radius: 8px;" class="img-fluid" title="Culture sur structure" webp="true" >}}
