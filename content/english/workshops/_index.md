...
<div class="flex flex-col md:flex-row md:items-start space-y-4 md:space-y-0 md:space-x-6">
 ...
 <div class="w-1/2">
  {{< image src="/images/atelier_lola.jpg" caption="Site preparation" alt="Lola" height="" width="" position="center" command="fill" option="q100" style="height: 400px; width: auto; object-fit: cover; border-radius: 8px;" class="img-fluid" title="" webp="true" >}}
 </div>
</div>